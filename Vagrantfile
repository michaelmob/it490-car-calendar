...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "dmz" do |subconfig|
    ...
    subconfig.vm.synced_folder "dmz/src/", "/home/vagrant/src"
    subconfig.ssh.password = "pass"

    subconfig.vm.provision "file", source: "packages", destination: "/home/vagrant/packages"
  ...
  config.vm.define "web" do |subconfig|
    ...
    subconfig.vm.synced_folder "web/src/", "/home/vagrant/src"
    subconfig.ssh.password = "pass"

    subconfig.vm.provision "file", source: "packages", destination: "/home/vagrant/packages"
    subconfig.vm.provision "file", source: "web/motd", destination: "/tmp/motd"
    subconfig.vm.provision "file", source: "web/nginx.conf", destination: "/tmp/nginx.conf"
  ...
  config.vm.define "db" do |subconfig|
    ...
    subconfig.vm.synced_folder "db/src/", "/home/vagrant/src"
    subconfig.vm.synced_folder "packages/", "/home/vagrant/packages"
    subconfig.ssh.password = "pass"
