...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "dmz" do |subconfig|
    ...
    subconfig.vm.network "private_network", ip: "10.1.0.2"
  end

  config.vm.define "web" do |subconfig|
    subconfig.vm.box = "ubuntu/bionic64"
    subconfig.vm.hostname = "web"
    subconfig.vm.network "private_network", ip: "10.1.0.3"
  ...
  config.vm.define "db" do |subconfig|
    ...
    subconfig.vm.network "private_network", ip: "10.1.0.4"
  end

  config.vm.define "rabbitmq" do |subconfig|
    subconfig.vm.box = "ubuntu/bionic64"
    subconfig.vm.hostname = "rabbitmq"
    subconfig.vm.network "private_network", ip: "10.1.0.5"
